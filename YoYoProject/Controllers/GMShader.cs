...
namespace YoYoProject.Controllers
{
    public sealed class GMShader : GMResource
    {
        ...
        internal override string ResourcePath => $@"shaders\{Name}\{Name}.yy";
        ...
        {
            Name = Project.Resources.GenerateValidName(name ?? "shader");
            ...
            FragmentContents = "// Hello, I am the fragment shader!";
            VertexContents = "// Hello, I am the vertex shader!";

            AddResourceToFolder("GMShader");
        }
